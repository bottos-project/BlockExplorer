<template>
  <div>
      <el-table :data="tableData" size="medium" v-loading="listLoading" :row-class-name="tableRowClassName" class="tables">
        ...
        <el-table-column prop="blockNum" :label="$t('supernodeDetail.table1')" min-width="100">
        ...
        <el-table-column prop="tradeDate" :label="$t('supernodeDetail.table2')" min-width="120">
          <template slot-scope="scope">
...
<script>
import {queryBlockList} from '@/api/supernode'
